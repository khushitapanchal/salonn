...
import { Plus, Edit2, Trash2, Scissors, ChevronDown } from 'lucide-react';
...
export default function ServicesPage() {
  ...
  return (
    <div>
          ...
          <div key={category} style={{ marginBottom: '2rem' }}>
            ...
            <div className={styles.grid}>
              {groupedServices[category].map(s => (
                <div key={s.id} className={dashStyles.statCard} style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '0.5rem' }}>
                  ...
                  <div style={{ marginTop: '1rem', display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'center', color: 'var(--text-muted)', fontSize: '0.875rem' }}>
      ...
      {showModal && (
        <div className={custStyles.modalOverlay}>
          <div className={custStyles.modal}>
